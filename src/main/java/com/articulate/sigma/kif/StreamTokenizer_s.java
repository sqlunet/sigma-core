...
public class StreamTokenizer_s
{
	...
	@SuppressWarnings("CanBeFinal") public boolean slashSlashCommentsP = false;

	@SuppressWarnings("CanBeFinal") public boolean slashStarCommentsP = false;
	 ...
	 */
	@SuppressWarnings("StatementWithEmptyBody") public int nextToken() throws IOException
	{
		if (pushedBack)
		{
			pushedBack = false;
